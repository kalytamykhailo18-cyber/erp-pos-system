...
router.post(
  ...
  [
    ...
    // Operating hours
    stringField('weekday_opening_time', { required: false }),
    stringField('weekday_closing_time', { required: false }),
    stringField('midday_closing_time', { required: false }),
    stringField('afternoon_opening_time', { required: false }),
    stringField('evening_closing_time', { required: false }),
    stringField('sunday_opening_time', { required: false }),
    stringField('sunday_closing_time', { required: false }),
